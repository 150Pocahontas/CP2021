...
OU   
      \ensuremath{\begin{lcbr}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{bop}\;\Varid{b}\;\Varid{c})\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{bop},(\Varid{b},\Varid{c}))))\\\Varid{outExpAr}\;(\Conid{Un}\;\Varid{uop}\;\Varid{d})\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{uop},\Varid{d})))\end{lcbr}}
\end{eqnarray*}
...
\centerline{\xymatrix{
   ExpAr \ar[d]_-{\ensuremath{\Varid{f}}}
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{outExpAr}}} & \qquad \cong
&   () + (Int + (BinOp \times (ExpAr \times ExpAr) + (UnOp \times ExpAr)))  \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{f}\times\Varid{f})\mathbin{+}(\Varid{id}\times\Varid{f})))}}
                                     \ar@/^2pc/ [ll]^-{\ensuremath{\Varid{inExpAr}}}
\\
    \ensuremath{\Conid{C}} &  & () + (Int + ((BinOp \times (C \times C)) + (UnOp \times C)))\ar[ll]
}}
...
\xymatrixcolsep{1pc}\xymatrixrowsep{5pc}
\centerline{\xymatrix{
   ExpAr \ar[d]_-{\ensuremath{\cata{\Varid{g\char95 eval\char95 exp}\;\Varid{a}}}}
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{outExpAr}}} & \qquad \cong
&   () + (Int + ((BinOp \times (ExpAr \times ExpAr)) + (UnOp \times ExpAr)))  \ar[d]^{\ensuremath{\Varid{recExpAr}\;\cata{\Varid{g\char95 eval\char95 exp}\;\Varid{a}}}}
\\
    \ensuremath{\Conid{Int}} &  & () + (Int + ((BinOp \times (Int \times Int)) + (UnOp \times Int)))\ar[ll]^-{\ensuremath{\Varid{g\char95 eval\char95 exp}\;\Varid{a}}}
}}
...
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b}){}\<[24]%
\>[24]{}\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{a},\Varid{b})))){}\<[E]%
\\
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\bot {}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{binOpAux}\;\Conid{Sum}\;\Varid{a}\;\Varid{b}\mathrel{=}(\mathbin{+})\;\Varid{a}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{binOpAux}\;\Conid{Product}\;\Varid{a}\;\Varid{b}{}\<[23]%
\>[23]{}\mathrel{=}(\mathbin{*})\;\Varid{a}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{unOpAux}\;\Conid{Negate}\;\Varid{a}\mathrel{=}\mathbin{-}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{unOpAux}\;\Conid{E}\;\Varid{a}\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{eliminaX}\;()\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
