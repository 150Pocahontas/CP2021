...
&   () + (a + (BinOp \times (ExpAr\ a \times ExpAr\ a) + (UnOp \times ExpAr\ a)))  \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{f}\times\Varid{f})\mathbin{+}(\Varid{id}\times\Varid{f})))}}
                                     \ar@/^2pc/ [ll]^-{\ensuremath{\Varid{inExpAr}}}
\\
    \ensuremath{\Conid{C}} &  & () + (a + ((BinOp \times (C \times C)) + (UnOp \times C)))\ar[ll]
}}
...
\centerline{\xymatrix{
   ExpAr\ a\ar[d]_-{\ensuremath{\cata{\Varid{g\char95 eval\char95 exp}\;\Varid{a}}}}
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{outExpAr}}} & \qquad \cong
&   () + (a + ((BinOp \times (ExpAr\ a \times ExpAr\ a)) + (UnOp \times ExpAr\ a)))  \ar[d]^{\ensuremath{\Varid{recExpAr}\;\cata{\Varid{g\char95 eval\char95 exp}\;\Varid{a}}}}
\\
    \ensuremath{\Varid{a}} &  & () + (a + ((BinOp \times (a \times a)) + (UnOp \times a)))\ar[ll]^-{\ensuremath{\Varid{g\char95 eval\char95 exp}\;\Varid{a}}}
}}
...
&   () + (a + ((BinOp \times (ExpAr\ a \times ExpAr\ a)) + (UnOp \times ExpAr\ a))) 
    ...
    \ensuremath{\Conid{ExpAr}\;\Varid{a}} &  & () + (a + ((BinOp \times (ExpAr\ a \times ExpAr\ a)) + (UnOp \times ExpAr\ a)))
...
\centerline{\xymatrix{
	ExpAr\ a
                ...
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{outExpAr}}} & \qquad \cong
&   () + (a + ((BinOp \times (ExpAr\ a \times ExpAr\ a)) + (UnOp \times ExpAr\ a)))  			\ar[d]^{\ensuremath{\Varid{recExpAr}\;\cata{\Varid{gopt}\;\Varid{a}}}}
\\
    \ensuremath{\Varid{a}} &  & () + (a + ((BinOp \times (a \times a)) + (UnOp \times a)))
...
\\
\>[B]{}\Varid{goptAux}\;(\Varid{op},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{binOpAux}\;(\Varid{op},(\Varid{a},\Varid{b})){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{sdAuxB}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{c},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{d})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{c}\;\Varid{b})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sdAuxU}\;(\Conid{Negate},(\Varid{a},\Varid{b}))\mathrel{=}(\Varid{a},\Conid{Un}\;\Conid{Negate}\;\Varid{b}){}\<[E]%
\\
...
\\
\>[B]{}\Varid{adAuxB}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}((\mathbin{*})\;\Varid{a}\;\Varid{c},(\mathbin{+})\;((\mathbin{*})\;\Varid{a}\;\Varid{d})\;((\mathbin{*})\;\Varid{c}\;\Varid{b})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{adAuxU}\;(\Conid{Negate},(\Varid{a},\Varid{b}))\mathrel{=}(\Varid{a},\mathbin{-}\Varid{b}){}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{f},\Varid{k},\Varid{s})\mathrel{=}(\Varid{f}\mathbin{+}\Varid{k}\div \Varid{s},\Varid{k}\mathbin{+}\mathrm{4},\Varid{s}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{2},\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{f},\Varid{k},\Varid{s})\mathrel{=}\Varid{f}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\\
    \ensuremath{((\Conid{OverTime}\;\Conid{NPoint})\mathbin{\uparrow}\Conid{NPoint})} &  & \ensuremath{()\mathbin{+}(\Conid{Q}\times(\Conid{OverTime}\;\Conid{NPoint}\mathbin{\uparrow}\Conid{NPoint}))}
          \ar[ll]^-{\ensuremath{\Varid{h}}}
}}
\vspace{0.3cm}
Analisando o tipo da função calcLine podemos concluir que o nosso objetivo final deve ser retornar uma função que dado um \textit{NPoint}, devolve um \textit{OverTime NPoint}. 
Tendo a consciência que poderiamos usar a versão uncurried desta função, resolvemos trabalhar os dois pontos como elementos separados e não um par, podendo saber qual elemento à cabeça do NPoint, o que nos permite avançar.
\vspace{0.5cm}
...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\mathrel{=}{}\<[8]%
\>[8]{}\alt{\Varid{nil}}{\Varid{linear}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{linear}\;(\Varid{x}\mathbin{:}\Varid{xs})\;(\Varid{y}\mathbin{:}\Varid{ys})\mathrel{=}(\Varid{linear1d}\;\Varid{x}\;\Varid{y})\mathbin{:}(\Varid{linear}\;\Varid{xs}\;\Varid{ys}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
...
%
      \ensuremath{\begin{lcbr}\Varid{avg}\comp \mathbf{in}\mathrel{=}\Varid{b}\comp \Conid{F}\;\conj{\Varid{avg}}{\length }\\\length \comp \mathbf{in}\mathrel{=}\Varid{q}\comp \Conid{F}\;\conj{\Varid{avg}}{\length }\end{lcbr}}
%
\just\equiv{\textcolor{blue}{in.out=id (2><)}}
%
      \ensuremath{\begin{lcbr}\Varid{avg}\mathrel{=}\Varid{b}\comp \Conid{F}\;\conj{\Varid{avg}}{\length }\comp \Varid{out}\\\length \mathrel{=}\Varid{q}\comp \Conid{F}\;\conj{\Varid{avg}}{\length }\comp \Varid{out}\end{lcbr}}
\end{eqnarray*}
...
\ttfamily ~let~plug~\char40{}\char40{}Dr~True~~a~r\char41{}\char58{}z\char41{}~t~\char61{}~Node~\char40{}a\char44{}\char40{}r\char44{}plug~z~t\char41{}\char41{}
\end{tabbing}
