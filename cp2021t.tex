...
%
      \ensuremath{\begin{lcbr}\Varid{id}\comp i_1\mathrel{=}\Varid{outExpAr}\comp \underline{\Conid{X}}\\\Varid{id}\comp i_2\mathrel{=}\Varid{outExpAr}\comp \Varid{num\char95 ops}\end{lcbr}}
%
\just\equiv{\textcolor{blue}{Natural-id\ (1),\ Igualdade\ Extensional\ (69),\ Def-comp\ (70)}}
%
      \ensuremath{\begin{lcbr}\Varid{outExpAr}\;\Conid{X}\mathrel{=}i_1\;()\\\Varid{outExpAr}\;(\Conid{N}\;\Varid{a})\mathrel{=}i_2\;(i_1\;\Varid{a})\end{lcbr}}
     \\ & &
      \ensuremath{\begin{lcbr}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b})\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{a},\Varid{b}))))\\\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;\Varid{a})\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{op},\Varid{a})))\end{lcbr}}
\end{eqnarray*}
...
\centerline{\xymatrix{
   ExpAr\ a \ar[d]_-{\ensuremath{\Varid{f}}}
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{outExpAr}}} & \qquad \cong
&   1 + (a + (BinOp \times (ExpAr\ a \times ExpAr\ a) + (UnOp \times ExpAr\ a)))  \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{f}\times\Varid{f})\mathbin{+}(\Varid{id}\times\Varid{f})))}}
                                     \ar@/^2pc/ [ll]^-{\ensuremath{\Varid{inExpAr}}}
\\
    \ensuremath{\Conid{C}} &  & 1 + (a + ((BinOp \times (C \times C)) + (UnOp \times C)))\ar[ll]
}}
...
\begin{eqnarray*}
\start
  recExpr\ f = {\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{f}\times\Varid{f})\mathbin{+}\Varid{id}\times\Varid{f}))}}
%
...
\centerline{\xymatrix{
   ExpAr\ a\ar[d]_-{\ensuremath{\cata{\Varid{g\char95 eval\char95 exp}\;\Varid{a}}}}
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{outExpAr}}} & \qquad \cong
&   1 + (a + ((BinOp \times (ExpAr\ a \times ExpAr\ a)) + (UnOp \times ExpAr\ a)))  \ar[d]^{\ensuremath{\Varid{recExpAr}\;\cata{\Varid{g\char95 eval\char95 exp}\;\Varid{a}}}}
\\
    \ensuremath{\Varid{a}} &  & 1 + (a + ((BinOp \times (a \times a)) + (UnOp \times a)))\ar[ll]^-{\ensuremath{\Varid{g\char95 eval\char95 exp}\;\Varid{a}}}
}}
...
{\xymatrix{
    ExpAr\ a
                ...
                \ar@/^2pc/ [rr]^{\ensuremath{\Varid{clean}}} & 
&   1 + (a + ((BinOp \times (ExpAr\ a \times ExpAr\ a)) + (UnOp \times ExpAr\ a))) 
				\ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{anaExpAr}\;(\Varid{clean}))}}\\
    \ensuremath{\Conid{ExpAr}\;\Varid{a}} &  & 1 + (a + ((BinOp \times (ExpAr\ a \times ExpAr\ a)) + (UnOp \times ExpAr\ a)))
    			\ar[ll]^-{\ensuremath{\Varid{inExpAr}}}
}}
...
\centerline{\xymatrix{
	ExpAr\ a
   				\ar[d]_-{\ensuremath{\cata{\Varid{gopt}\;\Varid{a}}}}
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{outExpAr}}} & \qquad \cong
&   1 + (a + ((BinOp \times (ExpAr\ a \times ExpAr\ a)) + (UnOp \times ExpAr\ a)))  			\ar[d]^{\ensuremath{\Varid{recExpAr}\;\cata{\Varid{gopt}\;\Varid{a}}}}
\\
    \ensuremath{\Varid{a}} &  & 1 + (a + ((BinOp \times (a \times a)) + (UnOp \times a)))
    			\ar[ll]^-{\ensuremath{\Varid{gopt}\;\Varid{a}}}
}}
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\Varid{calculaX}\;\Varid{a}}{\alt{\Varid{id}}{\alt{\Varid{binOpAux}}{\Varid{unOpAux}}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calculaX}\;\Varid{a}\;()\mathrel{=}\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{binOpAux}\;(\Conid{Sum},(\Varid{a},\Varid{b}))\mathrel{=}(\mathbin{+})\;\Varid{a}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{binOpAux}\;(\Conid{Product},(\Varid{a},\Varid{b}))\mathrel{=}(\mathbin{*})\;\Varid{a}\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{unOpAux}\;(\Conid{Negate},\Varid{a})\mathrel{=}\mathbin{-}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{unOpAux}\;(\Conid{E},\Varid{a})\mathrel{=}(\Varid{expd}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;(\Conid{N}\;\mathrm{0})\;\Varid{a})\mathrel{=}i_2\;(i_1\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;{}\<[21]%
\>[21]{}\Varid{a}\;(\Conid{N}\;\mathrm{0}))\mathrel{=}i_2\;(i_1\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;(\Conid{N}\;\mathrm{0})\;\Varid{a})\mathrel{=}\Varid{clean}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;(\Conid{N}\;\mathrm{0}))\mathrel{=}\Varid{clean}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;(\Conid{N}\;\mathrm{1})\;\Varid{a})\mathrel{=}\Varid{clean}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;(\Conid{N}\;\mathrm{1}))\mathrel{=}\Varid{clean}\;\Varid{a}{}\<[E]%
\\
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gopt}\;\Varid{a}\mathrel{=}\alt{\Varid{calculaX}\;\Varid{a}}{\alt{\Varid{id}}{\alt{\Varid{goptAux}}{\Varid{unOpAux}}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{goptAux}\;(\Conid{Sum},(\mathrm{0},\Varid{a}))\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{goptAux}\;(\Conid{Sum},(\Varid{a},\mathrm{0}))\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{goptAux}\;(\Conid{Product},(\mathrm{1},\Varid{a}))\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{goptAux}\;(\Conid{Product},(\Varid{a},\mathrm{1}))\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{goptAux}\;\Varid{a}\mathrel{=}\Varid{binOpAux}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\alt{\Varid{sdAuxX}}{\alt{\Varid{sdAuxN}}{\alt{\Varid{sdAuxB}}{\Varid{sdAuxU}}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sdAuxX}\;()\mathrel{=}(\Conid{X},\Conid{N}\;\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sdAuxN}\;\Varid{a}\mathrel{=}(\Conid{N}\;\Varid{a},\Conid{N}\;\mathrm{0}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sdAuxB}\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;\Varid{c},\Conid{Bin}\;\Conid{Sum}\;\Varid{b}\;\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{sdAuxB}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{c},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{d})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;\Varid{c})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sdAuxU}\;(\Conid{Negate},(\Varid{a},\Varid{b}))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{a},\Conid{Un}\;\Conid{Negate}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{sdAuxU}\;(\Conid{E},(\Varid{a},\Varid{b}))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{a},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{a})\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\;\Varid{v}\mathrel{=}\alt{\Varid{adAuxX}\;\Varid{v}}{\alt{\Varid{adAuxN}}{\alt{\Varid{adAuxB}}{\Varid{adAuxU}}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{adAuxX}\;\Varid{v}\;(){}\<[14]%
\>[14]{}\mathrel{=}(\Varid{v},\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{adAuxN}\;\Varid{a}\mathrel{=}(\Varid{a},\mathrm{0}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{adAuxB}\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}((\mathbin{+})\;\Varid{a}\;\Varid{c},(\mathbin{+})\;\Varid{b}\;\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{adAuxB}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}((\mathbin{*})\;\Varid{a}\;\Varid{c},(\mathbin{+})\;((\mathbin{*})\;\Varid{a}\;\Varid{d})\;((\mathbin{*})\;\Varid{b}\;\Varid{c})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{adAuxU}\;(\Conid{Negate},(\Varid{a},\Varid{b}))\mathrel{=}(\mathbin{-}\Varid{a},\mathbin{-}\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{adAuxU}\;(\Conid{E},(\Varid{a},\Varid{b}))\mathrel{=}(\Varid{expd}\;\Varid{a},(\mathbin{*})\;(\Varid{expd}\;\Varid{a})\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\pagebreak
...
\>[B]{}\Varid{f}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{f}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\frac{(\mathrm{2}\;(\Varid{n}\mathbin{+}\mathrm{1}))\mathbin{!}}{((\Varid{n}\mathbin{+}\mathrm{1})\mathbin{+}\mathrm{1})\mathbin{!}(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!}}\mathrel{=}\frac{(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{2})\mathbin{!}}{(\Varid{n}\mathbin{+}\mathrm{2})\mathbin{!}(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!}}\mathrel{=}\frac{(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{2})\;(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1})\;(\mathrm{2}\;\Varid{n})\mathbin{!}}{(\Varid{n}\mathbin{+}\mathrm{2})\;(\Varid{n}\mathbin{+}\mathrm{1})\;(\Varid{n})\mathbin{!}(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!}}\mathrel{=}\frac{\mathrm{2}\;(\Varid{n}\mathbin{+}\mathrm{1})\;(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1})\;(\mathrm{2}\;\Varid{n})\mathbin{!}}{(\Varid{n}\mathbin{+}\mathrm{2})\;(\Varid{n}\mathbin{+}\mathrm{1})\;(\Varid{n}\mathbin{!})\;(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!}}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathrel{=}\frac{\mathrm{2}\;(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1})\;(\mathrm{2}\;\Varid{n})\mathbin{!}}{(\Varid{n}\mathbin{+}\mathrm{2})\;(\Varid{n}\mathbin{!})\;(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!}}\mathrel{=}\frac{(\mathrm{2}\;\Varid{n})\mathbin{!}}{(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!}(\Varid{n})\mathbin{!}}\comp \frac{\mathrm{4}\;\Varid{n}\mathbin{+}\mathrm{2}}{\Varid{n}\mathbin{+}\mathrm{2}}\mathrel{=}\Varid{f}\;\Varid{n}\comp \frac{\Varid{k}\;\Varid{n}}{\Varid{s}\;\Varid{n}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{k}\;\Varid{n}\mathrel{=}\mathrm{4}\;\Varid{n}\mathbin{+}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{k}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{k}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\mathrm{4}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{+}\mathrm{2})\mathrel{=}\mathrm{4}\;\Varid{n}\mathbin{+}\mathrm{6}\mathrel{=}\Varid{k}\;\Varid{n}\mathbin{+}\mathrm{4}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{s}\;\Varid{n}\mathrel{=}\Varid{n}\mathbin{+}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{s}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{s}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{n}\mathbin{+}\mathrm{1}\mathbin{+}\mathrm{2}\mathrel{=}\Varid{s}\;\Varid{n}\mathbin{+}\mathrm{1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cat}\mathrel{=}\Varid{prj}\comp \for{\Varid{loop}}\ {\Varid{inic}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{loop}\;(\Varid{f},\Varid{k},\Varid{s})\mathrel{=}(\Varid{f}\mathbin{*}\Varid{k}\div \Varid{s},\Varid{k}\mathbin{+}\mathrm{4},\Varid{s}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{2},\mathrm{2}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{prj}\;(\Varid{f},\Varid{k},\Varid{s})\mathrel{=}\Varid{f}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&   1 + (\Q \times  NPoint)      
          \ar[d]^{\ensuremath{\Varid{recList}\;\cata{\Varid{h}}}}
\\
    \ensuremath{((\Conid{OverTime}\;\Conid{NPoint})\mathbin{\uparrow}\Conid{NPoint})} &  & \ensuremath{\mathrm{1}\mathbin{+}(\Conid{Q}\times(\Conid{OverTime}\;\Conid{NPoint}\mathbin{\uparrow}\Conid{NPoint}))}
          \ar[ll]^-{\ensuremath{\Varid{h}}}
}}
\vspace{0.5cm}
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h}\mathrel{=}\alt{\Varid{n}}{\Varid{linear}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{n}\mathbin{::}\Varid{a}\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{n}\;\Varid{a}\;\Varid{b}\mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{linear}\mathbin{::}(\Q ,\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint})\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{linear}\;(\Varid{d},\Varid{f})\;\Varid{l}\mathrel{=}\mathbf{case}\;\Varid{l}\;\mathbf{of}{}\<[E]%
\\
\>[5]{}\hsindent{3}{}\<[8]%
\>[8]{}[\mskip1.5mu \mskip1.5mu]{}\<[15]%
\>[15]{}\to \Varid{nil}{}\<[E]%
...
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
\>[B]{}\Varid{deCasteljau}\;\Varid{xs}\mathrel{=}\lambda \Varid{pt}\to \Varid{hyloAlgForm}\;(\Varid{alg}\;\Varid{xs}\;\Varid{pt})\;(\Varid{coalg}\;\Varid{xs}\;\Varid{pt})\;\Varid{pt}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{alg}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{pt}\mathrel{=}\Varid{nil}\;\Varid{pt}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{alg}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\;\Varid{pt}\mathrel{=}\underline{\Varid{x}}\;\Varid{pt}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{alg}\;\Varid{xs}\;\Varid{pt}\mathrel{=}\Varid{deCasteljau}\;(\Varid{init}\;\Varid{xs})\;\Varid{pt}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{coalg}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{pt}\mathrel{=}\Varid{nil}\;\Varid{pt}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{coalg}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\;\Varid{pt}\mathrel{=}\Varid{nil}\;\Varid{pt}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{coalg}\;\Varid{xs}\;\Varid{pt}\mathrel{=}\Varid{deCasteljau}\;(\Varid{tail}\;\Varid{xs})\;\Varid{pt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloAlgForm}\mathrel{=}\Varid{calcLine}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outSingle}\;(\Varid{a}\mathbin{:}[\mskip1.5mu \mskip1.5mu])\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outSingle}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}i_2\;(\Varid{x},\Varid{xs}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataSingle}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{recList}\;(\Varid{cataSingle}\;\Varid{g})\comp \Varid{outSingle}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\centerline{\xymatrix{
  A*
          \ar[d]_-{\ensuremath{\conj{\Varid{avg}}{\length }}}
                \ar [rr]^-{\ensuremath{\Varid{outSingle}}} & \qquad 
&   \ensuremath{\Conid{A}\mathbin{+}(\Conid{A}\times\Conid{A}\mathbin{*})}
          \ar[d]^{\ensuremath{\Varid{recList}\;\cata{\alt{\Varid{b}}{\Varid{q}}}}}
\\
    \ensuremath{(\Conid{A}\times\Conid{B})} &  & \ensuremath{\Conid{A}\mathbin{+}(\Conid{A}\times\Conid{B})}
          \ar[ll]^-{\ensuremath{\alt{\Varid{b}}{\Varid{q}}}}
}}
...
\\
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}{}\<[12]%
\>[12]{}\Varid{cataSingle}\;\alt{\Varid{b}}{\Varid{q}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b}{}\<[6]%
\>[6]{}\mathrel{=}{}\<[6E]%
\>[9]{}\conj{\Varid{id}}{\underline{\mathrm{1}}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{q}{}\<[6]%
\>[6]{}\mathrel{=}{}\<[6E]%
\>[9]{}\conj{\Varid{avgAux}}{\succ \comp \p2\comp \p2}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{avgAux}\;(\Varid{x},(\Varid{a},\Varid{l}))\mathrel{=}(\Varid{x}\mathbin{+}(\Varid{a}\mathbin{*}\Varid{l}))\mathbin{/}(\Varid{l}\mathbin{+}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avgLTree}\mathrel{=}\p1\comp \llparenthesis\, \alt{\Varid{b}}{\Varid{q}}\,\rrparenthesis\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b}\mathrel{=}\conj{\Varid{id}}{\underline{\mathrm{1}}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{q}\mathrel{=}\conj{\Varid{agvLTreeAux}}{\Varid{lTreeSize}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{agvLTreeAux}\;((\Varid{x1},\Varid{x2}),(\Varid{y1},\Varid{y2}))\mathrel{=}((\Varid{x1}\mathbin{*}\Varid{x2})\mathbin{+}(\Varid{y1}\mathbin{*}\Varid{y2}))\mathbin{/}(\Varid{x2}\mathbin{+}\Varid{y2}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{lTreeSize}\;((\Varid{x1},\Varid{x2}),(\Varid{y1},\Varid{y2}))\mathrel{=}\Varid{x2}\mathbin{+}\Varid{y2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\small
\begin{tabbing}\ttfamily
~\char47{}\char47{}~\char40{}1\char41{}~Datatype~definition~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\ttfamily ~\\
\ttfamily ~type~BTree\char60{}\char39{}a\char62{}~\char61{}~Empty~\char124{}~Node~of~a~\char42{}~of~BTree\char60{}\char39{}a\char62{}~\char42{}~BTree\char60{}\char39{}a\char62{}\\
\ttfamily ~\\
\ttfamily ~let~inBtree~x~\char61{}~either~\char40{}const~Empty\char41{}~Node~x\\
\ttfamily ~\\
\ttfamily ~let~outBTree~x~\char61{}\\
\ttfamily ~~~~~~match~x~with\\
\ttfamily ~~~~~~\char124{}~Empty~~\char45{}\char62{}~left~\char40{}\char41{}\\
\ttfamily ~~~~~~\char124{}~Node~\char40{}a\char44{}t1\char44{}t2\char41{}~\char45{}\char62{}~Rigth~\char40{}a\char44{}t1\char44{}t2\char41{}\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~baseBTree~g~f~\char61{}~g~\char45{}\char124{}\char45{}~\char40{}g~\char62{}\char60{}~\char40{}f~\char62{}\char60{}~f\char41{}\char41{}\\
\ttfamily ~\\
\ttfamily ~let~recBTree~f~\char61{}~baseBTree~id~f~\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~invBTree~x~\char61{}~cataBTree~\char40{}inLTree~\char60{}\char60{}~\char40{}id~\char45{}\char124{}\char45{}~id~\char62{}\char60{}~swap\char41{}\char41{}~x\\
\ttfamily ~\\
\ttfamily ~\char40{}\char42{}~Recall~the~pointwise~version\char58{}\\
\ttfamily ~invBTree~\char40{}\char41{}~\char61{}~Empty\\
\ttfamily ~invBTree~\char40{}Node~\char40{}a\char44{}\char40{}b\char44{}c\char41{}\char41{}\char41{}~\char61{}~Node~\char40{}a\char44{}~\char40{}invBTree~c\char44{}invBTree~b\char41{}\char41{}\\
...
\ttfamily ~\\
\ttfamily ~let~countBTree~x~\char61{}~cataBTree~\char40{}either~\char40{}const~0\char41{}~\char40{}succ~\char46{}~\char40{}uncurry~\char40{}\char43{}\char41{}\char41{}~\char46{}~p2\char41{}\char41{}~x\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~inordt~x~~\char61{}~either~nil~join~x\\
\ttfamily ~~~~~where~join~\char40{}x\char44{}\char40{}l\char44{}r\char41{}\char41{}~\char61{}~l~\char64{}~\char91{}x\char93{}~\char64{}~r\\
\ttfamily ~\\
\ttfamily ~let~preordt~x~\char61{}~cataBTree~preord~\\
\ttfamily ~\\
\ttfamily ~let~preord~\char61{}~\char40{}either~nil~f\char41{}~\\
\ttfamily ~~~~~~~where~~f\char40{}x\char44{}\char40{}l\char44{}r\char41{}\char41{}\char61{}~x\char58{}~l~\char64{}~r\\
\ttfamily ~\\
\ttfamily ~postordt~\char61{}~cataBTree~\char40{}either~nil~f\char41{}~\\
\ttfamily ~~~~~~~~~~~~where~~f\char40{}x\char44{}\char40{}l\char44{}r\char41{}\char41{}\char61{}l~\char64{}~r~\char64{}~\char91{}x\char93{}\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~qsep~\char91{}\char93{}~~~~\char61{}~Left~\char40{}\char41{}\\
\ttfamily ~let~qsep~\char40{}h\char58{}t\char41{}~\char61{}~Right~\char40{}h\char44{}\char40{}s\char44{}l\char41{}\char41{}~\\
\ttfamily ~~~~~~~where~\char40{}s\char44{}l\char41{}~\char61{}~part~\char40{}\char60{}h\char41{}~t\\
\ttfamily ~\\
\ttfamily ~let~part~p~\char91{}\char93{}~~~~~~~~~~~~~~~~\char61{}~\char40{}\char91{}\char93{}\char44{}\char91{}\char93{}\char41{}\\
\ttfamily ~let~part~p~\char40{}h\char58{}t\char41{}~\char124{}~p~h~~~~~~~\char61{}~let~\char40{}s\char44{}l\char41{}~\char61{}~part~p~t~in~\char40{}h\char58{}s\char44{}l\char41{}\\
\ttfamily ~~~~~~~~~~~~~~~~~~\char124{}~otherwise~\char61{}~let~\char40{}s\char44{}l\char41{}~\char61{}~part~p~t~in~\char40{}s\char44{}h\char58{}l\char41{}\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~traces~x~\char61{}~cataBTree~\char40{}either~\char40{}const~\char91{}\char91{}\char93{}\char93{}\char41{}~tunion\char41{}~x\\
\ttfamily ~\\
\ttfamily ~let~tunion~\char40{}a\char44{}\char40{}l\char44{}r\char41{}\char41{}~\char61{}~union~\char40{}map~\char40{}a\char58{}\char41{}~l\char41{}~\char40{}map~\char40{}a\char58{}\char41{}~r\char41{}~\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~strategy~\char40{}d\char44{}0\char41{}~\char61{}~Left~\char40{}\char41{}\\
\ttfamily ~strategy~\char40{}d\char44{}n\char43{}1\char41{}~\char61{}~Right~\char40{}\char40{}n\char44{}d\char41{}\char44{}\char40{}\char40{}not~d\char44{}n\char41{}\char44{}\char40{}not~d\char44{}n\char41{}\char41{}\char41{}\\
\ttfamily ~\\
\ttfamily ~\char45{}\char45{}~\char40{}5\char41{}~Depth~and~balancing~\char40{}using~mutual~recursion\char41{}~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\ttfamily ~\\
\ttfamily ~balBTree~\char61{}~p1\char46{}baldepth\\
\ttfamily ~\\
\ttfamily ~depthBTree~\char61{}~p2\char46{}baldepth\\
\ttfamily ~\\
\ttfamily ~baldepth~\char61{}~cataBTree~g~where\\
\ttfamily ~~~~~~g~\char61{}~either~\char40{}const\char40{}True\char44{}1\char41{}\char41{}~\char40{}h\char46{}\char40{}id\char62{}\char60{}f\char41{}\char41{}\\
\ttfamily ~~~~~~h\char40{}a\char44{}\char40{}\char40{}b1\char44{}b2\char41{}\char44{}\char40{}d1\char44{}d2\char41{}\char41{}\char41{}~\char61{}~\char40{}b1~\char38{}\char38{}~b2~\char38{}\char38{}~abs\char40{}d1\char45{}d2\char41{}\char60{}\char61{}1\char44{}1\char43{}max~d1~d2\char41{}\\
\ttfamily ~~~~~~f\char40{}\char40{}b1\char44{}d1\char41{}\char44{}\char40{}b2\char44{}d2\char41{}\char41{}~\char61{}~\char40{}\char40{}b1\char44{}b2\char41{}\char44{}\char40{}d1\char44{}d2\char41{}\char41{}\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~tnat~f~\char61{}~either~\char40{}const~mempty\char41{}~\char40{}theta~\char60{}\char60{}~\char40{}f~\char62{}\char60{}~theta\char41{}\char41{}\\
...
\ttfamily ~\\
\ttfamily ~let~plug~\char91{}\char93{}~t~\char61{}~t\\
\ttfamily ~let~plug~\char40{}\char40{}Dr~False~a~l\char41{}\char58{}z\char41{}~t~\char61{}~Node~\char40{}a\char44{}\char40{}plug~z~t\char44{}l\char41{}\char41{}\\
\ttfamily ~let~plug~\char40{}\char40{}Dr~True~~a~r\char41{}\char58{}z\char41{}~t~\char61{}~Node~\char40{}a\char44{}\char40{}r\char44{}plug~z\char44{}t\char41{}\char41{}
\end{tabbing}
