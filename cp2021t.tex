...
\\
    \ensuremath{\Conid{Eq}\;\Varid{a}} &  & () + (a + ((BinOp \times (Eq\ a \times Eq\ a)) + (UnOp \times Eq\ a)))
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gopt}\;\Varid{a}\mathrel{=}\alt{\Conid{True}}{\alt{\Conid{True}}{\alt{\Varid{goptAux}}{\Conid{True}}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{goptAux}\;(\Conid{Sum},(\mathrm{0},\Varid{a}))\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{goptAux}\;(\Conid{Sum},(\Varid{a},\mathrm{0}))\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{goptAux}\;(\Conid{Product},(\mathrm{1},\Varid{a}))\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{goptAux}\;(\Conid{Product},(\Varid{a},\mathrm{1}))\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{goptAux}\;(\Varid{op},(\Varid{a},\Varid{b}))\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
